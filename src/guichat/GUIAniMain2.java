...
public class GUIAniMain2 extends JPanel implements ActionListener {

	private Ellipse2D.Float ellipse = new Ellipse2D.Float();

	final int framespeed = 50;
	final private double MAXCounter = 5000;
	...
	private GUIAniBall[] myBallRims = new GUIAniBall[INIT_BALLNUM];

	public static void main(String[] args) {// main 関数
		/* おまじない：開始 */
		System.out.println("GUIAnimationFaceObjMain started");
		GUIAniMain2 animation = new GUIAniMain2();
	...
	void initProcess(int w, int h) {
		for (int i = 0; i < myBallRims.length; i++) {
			myBallRims[i] = new GUIAniBall(w, h);
		}
